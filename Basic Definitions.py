...
item1.name = 'Phone'  # This is called an attribute of the instance
item1.price = 130
item1.quantity = 21
print(item1.calculate_total_price(item1.price,item1.quantity))#Here object name this is Itemn is passed as first
